...
declare -a EXTRAS_STEPS=(
  ...
  "build-native-tcc|build-native-tcc.sh|Build tinycc (tcc)|builder|${WIN98_COMPAT_AR}:patches/tinycc/mob/series.txt:patches/tinycc/mob/0001-config-tccdir-relative-to-bin.patch"
