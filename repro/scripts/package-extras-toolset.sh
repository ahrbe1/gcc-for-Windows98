...
# muon) into out/package/gcc-win98-extras.zip. The archive's top-level
...
PACKAGE_NAME="gcc-win98-extras.zip"
...
# the hardlink call.
STAGE=$(mktemp -d -p "$PACKAGE_DIR" gcc-win98-extras-zip.XXXXXX)
