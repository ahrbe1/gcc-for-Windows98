...
status_step_line "build-native-jq"
status_step_line "build-native-tcc"
...
status_exists_line "$OUT_DIR/extras-toolset/bin/jq.exe"
status_exists_line "$OUT_DIR/extras-toolset/bin/tcc.exe"
